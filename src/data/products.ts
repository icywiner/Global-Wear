...
const rawProducts: Product[] = [
  ...
  { id: 'champion-reverse-weave', name: 'Reverse Weave Hoodie', brand: 'Champion', category: 'buzos', description: 'Champion Reverse Weave, buzo de algodón pesado original.', images: ['https://images.champion.com/is/image/champion/GF68_045_front?wid=800&hei=800'] },
  { id: 'champion-powerblend', name: 'Powerblend Hoodie', brand: 'Champion', category: 'buzos', description: 'Champion Powerblend, mezcla de algodón y poliéster anti-encogimiento.', images: ['https://images.champion.com/is/image/champion/S0889_806_front?wid=800&hei=800'] },
  ...
  { id: 'converse-go-to-hoodie', name: 'Go-To Star Chevron Hoodie', brand: 'Converse', category: 'buzos', description: 'Converse Go-To, buzo clásico con logo Star Chevron bordado.', images: [] },
